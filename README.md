...
Since no tools are available in the challange to analyse this file format, we have to contruct our own disassambler.
...
Locatation at the bottum, is a partial print from a second run, with the reference string artificially written to memory location 0x4b8 which returns "you did it!". 
...
With the following in instruction format (markdown file given in the challange):
